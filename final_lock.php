...
$reg_id = $_SESSION['reg_id'];
			...
			$body .= "THANK YOU for submitting your request for the faculty position : ". $faculty_pos . ", Department : ".$department. " at National Institute of Technology, Silchar.<br /><br/><br/><b>Login & See your submitted form and print it out, <a href='http://recruitment.nits.ac.in/rlogin_a.php'>CLICK HERE</a></b></div></body>";
			$nits_rec1->Mailer   = "smtp";
			$nits_rec1->Priority = '1';
			$nits_rec1->MsgHTML($body);
			$nits_rec1->AltBody = "THANK YOU for submitting your request for the faculty position : ". $faculty_pos . ", Department : ".$department. " at National Institute of Technology, Silchar.Login & See your submitted form and print it out, http://recruitment.nits.ac.in/rlogin_a.php";
